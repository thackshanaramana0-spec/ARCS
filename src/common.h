...
struct ARCSParams {
    ...
    bool   gutensor      = false;
    bool   use_mst       = false; // use MST tree encoder (legacy; chain-pg is default and smaller)
    ...
    bool   use_chain_pg  = true;  // chain-pg: build pseudogenome from chain walk (DEFAULT — 8/8 ratio win)
    int    threads       = 1;
